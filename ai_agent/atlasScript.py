...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "https://atlasnew-git-main-luigifaldettas-projects.vercel.app/", "https://atlasnew.vercel.app/"],  # Allow requests from your frontend
