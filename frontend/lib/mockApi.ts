...
export const calculateProjectedReturns = (propertyId: string, amount: number, years: number = 10): Promise<ProjectedReturns> => {
...
export const loginUser = (email: string, password: string): Promise<AuthResult> => {
...
export const registerUser = (email: string, password: string, name: string): Promise<AuthResult> => {
...
export const createInvestment = (userId: string, propertyId: string, amount: number): Promise<Investment> => {
