...
exports.analyzeProperty = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: 'Server error while starting property analysis' });
  }
};
...
exports.getAnalysisResults = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: 'Server error while fetching analysis results' });
  }
};
...
exports.getAnalysisHistory = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: 'Server error while fetching analysis history' });
  }
};
